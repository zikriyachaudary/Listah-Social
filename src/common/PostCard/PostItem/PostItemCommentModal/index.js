...
import { addReplyInComment, editCommentOfMine, postComment as postCommentAction } from '../../../../home/redux/actions';
      ...
      if (text) {
        ...
        if (isEditViewEnable) {
          ...
          if (replyViewEnable.text) {
            ...
            let subCommentList = replyComment.subCommentList ? replyComment.subCommentList : []
            const payload = {
              text,
              id: Date.now(),
              postId: post?.id,
...

          {
            ...
            <View style={{
              ...
              <Text style={{
                color: "gray",
                fontSize: 14
              }}>{replyViewEnable && replyViewEnable?.text ? replyViewEnable?.text : "Edit a comment"}</Text>
              <Touchable
                onPress={() => {
                  setEditViewEnable(null)
                  setText("")
...

          {
            ...
            <View style={{
              ...
              <Text style={{
                color: "gray",
                fontSize: 14
              }}>{replyViewEnable ? replyViewEnable?.text : ""}</Text>
              <Touchable
                onPress={() => {
                  setReplyViewEnable(null)
                  setText("")
...
export default connect(mapStateToProps, mapDispatchToProps)(PostItemCommentModal);
